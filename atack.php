...
<body>
    ...
    <div class="main">
        ...
        <div class="post">
            <form class="post_form" action="http://localhost/board/new_thread.php" method="POST">
                <?php echo $_SESSION['csrfToken'] ?>
                <input type="hidden" name="token" value="<?php echo $_SESSION['csrfToken'] ?>">
                <p>　タイトル　<textarea name="title" cols="40" rows="2">'csrf'</textarea></p>
                <p>　　内容　　<textarea name="content" cols="40" rows="10">'csrf'</textarea></p>
