    ...
    <div class="main">
        ...
        <div class="content">
            <div class="content_thread_list">
                ...
                <?php
                foreach ($data as $a) {
                    echo '<p>タイトル：' . '<a href="./thread/thread.php?id=' . $a['id'] . '">' . mb_strimwidth($a['title'], 0, 64, '...', 'UTF-8')  . '</a></p>';
        ...
        <div class="bottom">
            <p><a href="./thread/index.php"><button class="btn btn_blue" type="button">もっとみる</button></a></p>
        </div>
